...
(function($) {
    $.fn.extend({
        "message": function(options) {
            ...
            var div = $('<div class="alert ' + options.className + '" role="alert" >' +
                options.title + options.msg + '<span class="close" id="closeLoginMessage" type="button" data-dismiss="alert">×</span>' +
                '</div>');
            $('body').append(div);
