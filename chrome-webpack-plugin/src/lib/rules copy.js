...
const ruleInfo = {
  ...
  '1688.com':
    '{\n' +
    "\"detect\":\"if ((/1688\\\\.com\\\\/offer\\\\/\\\\d+\\\\.html/).test(url)) {\\n  return 'detail';\\n}\\nif ((/\\\\/page\\\\/offerlist/).test(url)) {\\n  return 'category';\\n}\\nif(url.indexOf('selloffer/offer_search') !== -1 ){return 'sortlist';}\",\n" +
    "\"detail\":\"if(url.indexOf('1688.com/offer') !== -1 || url.indexOf('1688.com/ci_bb') !== -1 || url.indexOf('1688.com/ci_king') !== -1 ){return true;}\",\n" +
    '"map":{"detail":"single","category":"category"}}',
  'alibaba.com':
    '{\n' +
