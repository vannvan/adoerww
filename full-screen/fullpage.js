  ...
  $.fn.fullpage = function (options) {
    ...
    function setOptionsFromDOM() {
      ...
      if (!options.navigationTooltips.length) {
        options.navigationTooltips = $(options.sectionSelector + '[data-tooltip]')
          .map(function () {
    ...
    function landscapeScroll(slides, destiny) {
      ...
      if (options.css3) {
        ...
        addAnimation(slides.find(SLIDES_CONTAINER_SEL), options.scrollingSpeed > 0).css(
    ...
    function addTableClass(element) {
      element
        .addClass(TABLE)
        .wrapInner(
          '<div class="' + TABLE_CELL + '" style="height:' + getTableHeight(element) + 'px;" />'
        )
    }
