const Baidu = {
  ...
  setMenhera: function () {
    ...
    countInfo.style.cssText =
      'width:300px;height:0px;background-image:url(https://acg.yanwz.cn/menhera/api.php);background-size:100% auto;padding-top:10%;position:fixed;bottom:0;right:0'
    ...
    let infoText =
      this.count > 0
        ? `已屏蔽${this.count}条CSDN垃圾推荐`
        : '真好，本次查询没有垃圾信息'
    countPanel.style.cssText =
      'position:fixed;bottom:170px;right:300px;color:#bdc3c7'
